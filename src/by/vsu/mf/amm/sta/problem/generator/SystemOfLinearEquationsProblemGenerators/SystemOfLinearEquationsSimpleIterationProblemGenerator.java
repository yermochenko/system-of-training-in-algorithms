...
public class SystemOfLinearEquationsSimpleIterationProblemGenerator
        implements ProblemGenerator<SystemOfLinearEquationsProblemSimpleIterationMethod, SimpleIteration> {
    ...
    @Override
    public void generate(SystemOfLinearEquationsProblemSimpleIterationMethod problem, SimpleIteration method) {
        if (minSize > 0) {
            if (minSize <= maxSize) {
